...
@Test
public class EmailPushTranslationTest {
  ...
  public void translateEmailPush() throws Exception {
    Push oldPush = EmailPush.newPush("mickey.mouse@disney.com", "donald.duck@disney.com", "This is the subject", "<html><body><h1>Hello World</h1>So, how's it going?</body></html>", "http://callback.com/api.sent", null, "test:true", "type:email");
    ...
    Push newPush = translator.fromJson(EmailPush.class, json);
